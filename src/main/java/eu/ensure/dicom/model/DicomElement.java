                    ...
                    try {
                        switch (vr) {
                            ...
                            case AE: // Application Entity
                                ...
                                value = (isNull ? "<null>" : valueToString(vr.toStrings(_value, isBE, characterSet)));
                                break;
                            ...
                            case SQ: // Sequence of items
                                ...
                                if (!isNull) {
                                    ...
                                    for (Attributes sequenceAttributes : sequence) {
                                        log.debug("Loading sequence (#" + (children.size() + 1) + ")");
                                        DicomElement subObject = new DicomElement(tag, name, sequenceAttributes, currentObject);
                            ...
                            default: //
                                value = valueToString((isNull ? "<null>" : vr.toStrings(_value, isBE, characterSet)));
                                break;
                        }
